( function() {
  ...
  */
  ...
  var justNumbers = numberObjects.map( function( item, index, array ) {
    return numberObjects[index].number;
  } );
  ...
  */
  ...
  var justMod2Or3 = justNumbers.filter( function( item, index, array ) {
    return justNumbers[index] % 2 === 0 || justNumbers[index] % 3 === 0;
  } );
  ...
  */
  ...
  var name = [ 'Mar', 'co' ];
  var p = name.reduce( function( acumulado, atual, index, array ) {
  ...
  */
  ...
  var inversedName = name.reduceRight( function( acumulado, atual, index, array ) {
    return (acumulado + atual).toString();
  } );
